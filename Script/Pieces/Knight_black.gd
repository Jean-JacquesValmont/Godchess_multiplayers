...
func _ready():
	...
	if my_node_name == "Knight_black":
		i = 2
		j = 3
	elif my_node_name == "Knight_black2":
		i = 2
		j = 8
...
func _input(event):
	...
	if player_in_game != null :
		if player_in_game.keys()[1] == get_tree().get_network_unique_id():
				...
				if player_turn == "black":
					...
					and event.button_index == BUTTON_LEFT and piece_select == my_node_name:
						...
						if piece_protects_against_an_attack == false:
							...
							and (position_piece_on_the_chessboard[i-2][j+1] == "0" or position_piece_on_the_chessboard[i-2][j+1] == "pawn_white"\
							or position_piece_on_the_chessboard[i-2][j+1] == "knight_white" or position_piece_on_the_chessboard[i-2][j+1] == "bishop_white"\
							or position_piece_on_the_chessboard[i-2][j+1] == "rook_white" or position_piece_on_the_chessboard[i-2][j+1] == "queen_white"):
							...
							and (position_piece_on_the_chessboard[i-1][j+2] == "0" or position_piece_on_the_chessboard[i-1][j+2] == "pawn_white"\
							or position_piece_on_the_chessboard[i-1][j+2] == "knight_white" or position_piece_on_the_chessboard[i-1][j+2] == "bishop_white"\
							or position_piece_on_the_chessboard[i-1][j+2] == "rook_white" or position_piece_on_the_chessboard[i-1][j+2] == "queen_white"):
								#Bouge la pièce de move_one_square = 100 en y
...
func preview_move():
	...
	if piece_select == my_node_name and king_in_check == false and piece_protects_against_an_attack == false:
		...
		if position_piece_on_the_chessboard[i-2][j+1] == "0":
			Move_Preview.get_node("Knight_black_preview_move").visible = true
		elif (position_piece_on_the_chessboard[i-2][j+1] == "pawn_white"\
		or position_piece_on_the_chessboard[i-2][j+1] == "knight_white" or position_piece_on_the_chessboard[i-2][j+1] == "bishop_white"\
		or position_piece_on_the_chessboard[i-2][j+1] == "rook_white" or position_piece_on_the_chessboard[i-2][j+1] == "queen_white"):
		...
		#Déplacement en haut à gauche
		if position_piece_on_the_chessboard[i-2][j-1] == "0":
			Move_Preview.get_node("Knight_black_preview_move2").visible = true
		elif (position_piece_on_the_chessboard[i-2][j-1] == "pawn_white"\
		or position_piece_on_the_chessboard[i-2][j-1] == "knight_white" or position_piece_on_the_chessboard[i-2][j-1] == "bishop_white"\
		or position_piece_on_the_chessboard[i-2][j-1] == "rook_white" or position_piece_on_the_chessboard[i-2][j-1] == "queen_white"):
		...
		if position_piece_on_the_chessboard[i-1][j+2] == "0":
			Move_Preview.get_node("Knight_black_preview_move3").visible = true
		elif (position_piece_on_the_chessboard[i+1][j+2] == "pawn_white"\
		or position_piece_on_the_chessboard[i-1][j+2] == "knight_white" or position_piece_on_the_chessboard[i-1][j+2] == "bishop_white"\
		or position_piece_on_the_chessboard[i-1][j+2] == "rook_white" or position_piece_on_the_chessboard[i-1][j+2] == "queen_white"):
		...
		#Déplacement vers la droite en bas
		if position_piece_on_the_chessboard[i+1][j+2] == "0":
			Move_Preview.get_node("Knight_black_preview_move4").visible = true
		elif (position_piece_on_the_chessboard[i+1][j+2] == "pawn_white"\
		or position_piece_on_the_chessboard[i+1][j+2] == "knight_white" or position_piece_on_the_chessboard[i+1][j+2] == "bishop_white"\
		or position_piece_on_the_chessboard[i+1][j+2] == "rook_white" or position_piece_on_the_chessboard[i+1][j+2] == "queen_white"):
		...
		#Déplacement en bas à droite
		if position_piece_on_the_chessboard[i+2][j+1] == "0":
			Move_Preview.get_node("Knight_black_preview_move5").visible = true
		elif (position_piece_on_the_chessboard[i+2][j+1] == "pawn_white"\
		or position_piece_on_the_chessboard[i+2][j+1] == "knight_white" or position_piece_on_the_chessboard[i+2][j+1] == "bishop_white"\
		or position_piece_on_the_chessboard[i+2][j+1] == "rook_white" or position_piece_on_the_chessboard[i+2][j+1] == "queen_white"):
		...
		#Déplacement en bas à gauche
		if position_piece_on_the_chessboard[i+2][j-1] == "0":
			Move_Preview.get_node("Knight_black_preview_move6").visible = true
		elif (position_piece_on_the_chessboard[i+2][j-1] == "pawn_white"\
		or position_piece_on_the_chessboard[i+2][j-1] == "knight_white" or position_piece_on_the_chessboard[i+2][j-1] == "bishop_white"\
		or position_piece_on_the_chessboard[i+2][j-1] == "rook_white" or position_piece_on_the_chessboard[i+2][j-1] == "queen_white"):
		...
		#Déplacement vers la gauche en haut
		if position_piece_on_the_chessboard[i-1][j-2] == "0":
			Move_Preview.get_node("Knight_black_preview_move7").visible = true
		elif (position_piece_on_the_chessboard[i-1][j-2] == "pawn_white"\
		or position_piece_on_the_chessboard[i-1][j-2] == "knight_white" or position_piece_on_the_chessboard[i-1][j-2] == "bishop_white"\
		or position_piece_on_the_chessboard[i-1][j-2] == "rook_white" or position_piece_on_the_chessboard[i-1][j-2] == "queen_white"):
		...
		#Déplacement vers la gauche en bas
		if position_piece_on_the_chessboard[i+1][j-2] == "0":
			Move_Preview.get_node("Knight_black_preview_move8").visible = true
		elif (position_piece_on_the_chessboard[i+1][j-2] == "pawn_white"\
		or position_piece_on_the_chessboard[i+1][j-2] == "knight_white" or position_piece_on_the_chessboard[i+1][j-2] == "bishop_white"\
		or position_piece_on_the_chessboard[i+1][j-2] == "rook_white" or position_piece_on_the_chessboard[i+1][j-2] == "queen_white"):
		...
		and Move_Preview.get_node("Knight_black_preview_move").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move").visible = true
		...
		if position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move2").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move2").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move2").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move3").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move3").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move3").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move4").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move4").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move4").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move5").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move5").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move5").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move6").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move6").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move6").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move7").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move7").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move7").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move8").position.y == (attacker_position_shift_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move8").position.x == (attacker_position_shift_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move8").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift_i][attacker_position_shift_j] != "0"\
		...
		and Move_Preview.get_node("Knight_black_preview_move").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move").visible = true
		...
		if position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move2").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move2").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move2").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move3").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move3").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move3").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move4").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move4").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move4").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move5").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move5").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move5").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move6").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move6").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move6").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move7").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move7").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move7").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] != "0"\
		...
		if position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] == "0"\
		and Move_Preview.get_node("Knight_black_preview_move8").position.y == (attacker_position_shift2_i - i) * 100\
		and Move_Preview.get_node("Knight_black_preview_move8").position.x == (attacker_position_shift2_j - j) * 100:
			Move_Preview.get_node("Knight_black_preview_move8").visible = true
		elif position_piece_on_the_chessboard[attacker_position_shift2_i][attacker_position_shift2_j] != "0"\
		...
		Move_Preview.get_node("Knight_black_preview_move").visible = false
		Move_Preview.get_node("Square_attack_preview").visible = false
		Move_Preview.get_node("Knight_black_preview_move2").visible = false
		Move_Preview.get_node("Square_attack_preview2").visible = false
		Move_Preview.get_node("Knight_black_preview_move3").visible = false
		Move_Preview.get_node("Square_attack_preview3").visible = false
		Move_Preview.get_node("Knight_black_preview_move4").visible = false
		Move_Preview.get_node("Square_attack_preview4").visible = false
		Move_Preview.get_node("Knight_black_preview_move5").visible = false
		Move_Preview.get_node("Square_attack_preview5").visible = false
		Move_Preview.get_node("Knight_black_preview_move6").visible = false
		Move_Preview.get_node("Square_attack_preview6").visible = false
		Move_Preview.get_node("Knight_black_preview_move7").visible = false
		Move_Preview.get_node("Square_attack_preview7").visible = false
		Move_Preview.get_node("Knight_black_preview_move8").visible = false
