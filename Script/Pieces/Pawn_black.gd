...
func _process(delta):
	...
	if i == 9 and piece_promoted == false:
		...
		if piece_select == "Promotion" and display_promotion == false:
			...
			knight_promotion_sprite.texture = load("res://Image/Pieces/Black/knight_black.png")
			...
			bishop_promotion_sprite.texture = load("res://Image/Pieces/Black/bishop_black.png")
			...
			rook_promotion_sprite.texture = load("res://Image/Pieces/Black/rook_black.png")
			...
			queen_promotion_sprite.texture = load("res://Image/Pieces/Black/queen_black.png")
			...
			if get_parent().get_node("Bishop_white2") != null and is_instance_valid(get_parent().get_node("Bishop_white")) == true:
	...
	if player_in_game != null :
		if player_in_game.keys()[1] == get_tree().get_network_unique_id():
			...
			and event.button_index == BUTTON_LEFT and piece_select == "Promotion":
				...
				and mouse_pos.y >= 450 - position.y and mouse_pos.y <= 650 - position.y:
					texture = load("res://Image/Pieces/Black/knight_black.png")
				...
				and mouse_pos.y >= 450 - position.y and mouse_pos.y <= 650 - position.y:
					texture = load("res://Image/Pieces/Black/bishop_black.png")
				...
				and mouse_pos.y >= 450 - position.y and mouse_pos.y <= 650 - position.y:
					texture = load("res://Image/Pieces/Black/rook_black.png")
				...
				and mouse_pos.y >= 450 - position.y and mouse_pos.y <= 650 - position.y:
					texture = load("res://Image/Pieces/Black/queen_black.png")
