					...
					and event.button_index == BUTTON_LEFT and piece_select == my_node_name:
						...
						if piece_protects_against_an_attack == false:
							...
							for f in range(max_move_up_right):
								if mouse_pos.x >= 0 + f*move_one_square and mouse_pos.x <= texture.get_width() + f*move_one_square \
								and mouse_pos.y >= 0 - f*move_one_square and mouse_pos.y <= texture.get_height() - f*move_one_square \
								and (position_piece_on_the_chessboard[i-f][j+f] == "0" or position_piece_on_the_chessboard[i-f][j+f] == "pawn_black"\
								or position_piece_on_the_chessboard[i-f][j+f] == "knight_black" or position_piece_on_the_chessboard[i-f][j+f] == "bishop_black"\
								or position_piece_on_the_chessboard[i-f][j+f] == "rook_black" or position_piece_on_the_chessboard[i-f][j+f] == "queen_black"):
									#Bouge la pièce de move_one_square = 100 en y
									var move_piece_y = -f*move_one_square
									var move_piece_x = f*move_one_square
									move_local_y(move_piece_y)
				...
				if player_turn == "white":
					...
					and event.button_index == BUTTON_LEFT and piece_select == my_node_name:
						...
						if piece_protects_against_an_attack == false:
							...
							and (position_piece_on_the_chessboard[attacker_position_shift3_i][attacker_position_shift3_j] == "0" or position_piece_on_the_chessboard[attacker_position_shift3_i][attacker_position_shift3_j] == "pawn_black"\
							or position_piece_on_the_chessboard[attacker_position_shift3_i][attacker_position_shift3_j] == "knight_black" or position_piece_on_the_chessboard[attacker_position_shift3_i][attacker_position_shift3_j] == "bishop_black"\
							or position_piece_on_the_chessboard[attacker_position_shift3_i][attacker_position_shift3_j] == "rook_black" or position_piece_on_the_chessboard[attacker_position_shift3_i][attacker_position_shift3_j] == "queen_black"):
								#Bouge la pièce de move_one_square = 100 en y
...
func preview_move():
	...
	if piece_select == my_node_name and king_in_check == false and piece_protects_against_an_attack == false:
		for f in range(1,max_move_up):
			...
			elif position_piece_on_the_chessboard[i-f][j] == "pawn_black"\
			or position_piece_on_the_chessboard[i-f][j] == "knight_black" or position_piece_on_the_chessboard[i-f][j] == "bishop_black"\
			or position_piece_on_the_chessboard[i-f][j] == "rook_black" or position_piece_on_the_chessboard[i-f][j] == "queen_black":
		...
		for f in range(1,max_move_right):
			...
			elif position_piece_on_the_chessboard[i][j+f] == "pawn_black"\
			or position_piece_on_the_chessboard[i][j+f] == "knight_black" or position_piece_on_the_chessboard[i][j+f] == "bishop_black"\
			or position_piece_on_the_chessboard[i][j+f] == "rook_black" or position_piece_on_the_chessboard[i][j+f] == "queen_black":
		...
		for f in range(1,max_move_up_right):
			...
			elif position_piece_on_the_chessboard[i-f][j+f] == "pawn_black"\
			or position_piece_on_the_chessboard[i-f][j+f] == "knight_black" or position_piece_on_the_chessboard[i-f][j+f] == "bishop_black"\
			or position_piece_on_the_chessboard[i-f][j+f] == "rook_black" or position_piece_on_the_chessboard[i-f][j+f] == "queen_black":
